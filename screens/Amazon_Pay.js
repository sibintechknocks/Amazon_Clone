...
export default class Amazon_Pay extends Component {
  render() {
    return (
      <>
      ...
      <TouchableOpacity
        ...
        <Text style={{fontSize: 25, color:'cyan', padding: 19, paddingHorizontal:23, marginTop:200, marginLeft:99, fontWeight:'bold' }}>
            Amazon_Pay
        </Text>
      </TouchableOpacity> 
      </View>
