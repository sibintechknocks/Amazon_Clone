...
export default class Fun_Zone extends Component {
  render() {
    return (
      <>
...
<LinearGradient 
    ...
    <View style={{height: 60, flexDirection: 'column'}}>
      ...
      <TouchableOpacity
        ...
        <Text style={{fontSize: 25, color:'cyan', padding: 19, paddingHorizontal:23, marginTop:200, marginLeft:120, fontWeight:'bold' }}>
          Fun Zone
        </Text>
      </TouchableOpacity> 
      </View>
