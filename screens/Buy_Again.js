...
export default class Buy_Again extends Component {
  render() {
    return (
      <>
...
<LinearGradient 
    ...
    <View style={{height: 60, flexDirection: 'column'}}>
      ...
      <TouchableOpacity
        ...
        <Text style={{fontSize: 25, color:'cyan', padding: 19, paddingHorizontal:23, marginTop:200, marginLeft:111, fontWeight:'bold' }}>
          Buy Again
        </Text>
      </TouchableOpacity> 
      </View>
